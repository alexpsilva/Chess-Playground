...
//   private piecesById: {[x: string]: Piece} = {}
...
//   changePieceType(pieceId: string, type: PieceType){
//     this.getPieceById(pieceId).type = type
//   }
...
//     //   pieceId,
//     //   origin: new PiecePosition({raw: piece.position.raw}),
//     //   destination: new PiecePosition({raw: destination.raw})
//     // })
...
//   hopMovementPositions(pieceId: string, offsets: [number, number][]) {
...
//   directionalMovementPositions(pieceId: string, directions: [number, number][], options?: {distanceLimit?: number, canCapture?: boolean}) {
//     const positions: PiecePosition[] = []
//     const piece = this.getPieceById(pieceId)
...
//   capturePositions(pieceId: string): PiecePosition[] {
//     const piece = this.getPieceById(pieceId)
//     switch(piece.type) {
//       case PieceType.pawn:
...
//     // const lastMove = this.moveHistory[-1]
//     // const lastMovePiece = this.getPieceById(lastMove.pieceId)
//     // if(lastMovePiece.type === PieceType.pawn) {
//     //   const middleBoardRow = 4.5 + 0.5*pawnDirection
//     //   if(piece.position.row === middleBoardRow && lastMove.destination.row === middleBoardRow) {
//     //   }
//     // }
//     return positions
//   }
...
//   nonCapturePositions(pieceId: string): PiecePosition[] {
//     const piece = this.getPieceById(pieceId)
//     const positions: PiecePosition[] = []
...
//   legalPositions = (pieceId: string): PiecePosition[] => {
